...
public class Questao40Controller extends BaseController{
    ...
    private boolean abrirArquivo() {
        ...
        selecionador.setInitialDirectory(new File(System.getProperty("user.dir")));
    ...
    private boolean salvarArquivo() {
        try {
            BufferedWriter escritor = new BufferedWriter(new FileWriter(App.raizProjeto + caminho + pastaArquivo + nomeArquivo + tipoArquivo));
