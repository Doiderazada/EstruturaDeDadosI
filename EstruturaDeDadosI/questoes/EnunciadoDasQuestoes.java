...
public abstract class EnunciadoDasQuestoes {
    ...
    public static final String questao1 = "1. Inicialize variáveis adequadas para: sua idade, sua altura, "+
    "primeira letra do seu nome, seu nome completo. Depois exiba os dados na tela.";

    public static final String questao2 = "2. Atribua com valores vindos do teclado variáveis adequadas para: sua idade, "+
    "sua altura, primeira letra do seu nome, seu nome completo. Depois exiba os dados na tela.";

    public static final String questao3 = "3. Receba do teclado dois números inteiros, calcule e exiba os resultados "+
    "das seguintes operações: adição, subtração, multiplicação, quociente da divisão e o resto da divisão.";

    public static final String questao4 = "4. Calcular e exibir a média aritmética de três números inteiros.";

    public static final String questao5 = "5. Calcular e exibir a média aritmética de três números reais.";

    public static final String questao6 = "6. Construa um programa que gerencia a conta de uma pizzaria.\r\n" + 
    ...
    public static final String questao7 = "7. Calcular uma divisão entre dois números reais. Produza um alerta em caso de divisão por zero.";

    public static final String questao8 = "8. Calcular o IMC (índice de massa corporal) de uma pessoa. Produza um alerta em caso de divisão por zero.";

    public static final String questao9 = "9. Construa um programa que calcule a área de um círculo, tendo como entrada o valor do raio, "+
    "que deve ser positivo. Use o valor da constante PI vindo da biblioteca matemática.";

    public static final String questao10 = "10. Construa um programa que leia um número inteiro e identifique se ele é par ou ímpar.";

    public static final String questao11 = "11. Construa um programa que simule uma transferência bancária, entre duas contas. "+
    ...
    public static final String questao12 = "12. Distinguir, com base na média parcial do aluno, se ele está aprovado, reprovado ou na final. Aplique as regras da UFERSA.";

    public static final String questao13 = "13. Construa um programa que calcule para o aluno sua média parcial e informe sua "+
    ...
    public static final String questao14 = "14. Construa um programa que calcule uma equação do 2º grau. "+
    "\nCrie uma função com retorno para calcular o delta.";

    public static final String questao15 = "15. Construa um programa que leia um número inteiro digitado pelo usuário. Caso o "+
    ...
    public static final String questao16 = "16. Construa um programa que leia do usuário um número inicial e um número final. Em seguida, exiba na tela uma sequência com os números desse\r\n" +
    ...
    public static final String questao17 = "17. Construa um programa que leia do usuário um número inicial e um número final. Em seguida, exiba na tela uma sequência apenas com os\r\n" +
    ...
    public static final String questao18 = "18. Verificar se a senha, informada durante a execução, é correta. Quando a senha estiver correta, exiba “senha correta” e o programa é encerrado.\r\n" + 
    ...
    public static final String questao19 = "19. Construa um programa para exibir a tabuada de qualquer número “n” (1 a 9), "+
    "sendo “n” um número fornecido pelo usuário. Utilize estrutura de repetição.";

    public static final String questao20 = "20. Construa um programa que calcule o rendimento mensal de um investimento em poupança. "+
    ...
    public static final String questao21 = "21. Construa um programa que identifique se um número é primo.";

    public static final String questao22 = "22. Construa um programa que calcule o somatório dos números inteiros de um intervalo, "+
    "definido por um número inicial e um número final. \nExemplo: caso as entradas fossem 4 e 9, o resultado seria: 39";

    public static final String questao23 = "23. Construa um programa que calcule o número fatorial de um número. "+
    "Use uma estrutura de repetição. Fatorial: n! = n (n - 1)! \nExemplo: 5! = 5 x 4 x 3 x 2 x 1 = 120 ou 5! = 1 x 2 x 3 x 4 x 5 = 120";

    public static final String questao24 = "24. Construa um programa que simule uma calculadora. Disponibilize um menu de opções e simule a opção desejada, exibindo novamente o menu,\r\n" +
    ...
    public static final String questao25 = "25. Construa um programa para ler e exibir um vetor de inteiros. "+
    "Em tempo de execução, o usuário pode definir o tamanho do vetor.";

    public static final String questao26 = "26. Construa um programa para ler e exibir uma matriz de inteiros. "+
    "Em tempo de execução, o usuário pode definir o tamanho da matriz.";

    public static final String questao27 = "27. Construa e use uma função que produz um novo vetor de "+
    "inteiros com a ordem inversa do vetor original passado por parâmetro.";

    public static final String questao28 = "28. Construa um programa que identifique o "+
    "maior e o menor número de um vetor de inteiros.";

    public static final String questao29 = "29. Construa um programa que mova o número da última posição de um vetor para a "+
    ...
    public static final String questao30 = "30. Construa um programa que inverta a frase digitada pelo usuário. "+
    "Por exemplo, se string1 for “bom dia”, então string2 será “aid mob”.";

    public static final String questao31 = "31. Construa um programa que registre objetos da classe Pessoa, com os "+
    ...
    public static final String questao32 = "32. Evolua a questão anterior. Permita que o programa salve o resultado"+
    " em um arquivo binário. Permita que o programa abra o arquivo binário e exiba o conteúdo na tela.";

    public static final String questao33 = "33. Construa um programa que conte a quantidade de letras de uma "+
    "palavra. Exemplo: “casa” Resultado: c=1 a =2 s =1";

    public static final String questao34 = "34. Construa um programa que conte a quantidade de vezes que as palavras de "+
    "uma frase aparecem. \nExemplo: “estude muito sempre sempre estude” Resultado: estude=2 muito=1 sempre=2";

    public static final String questao35 = "35. Evolua a questão anterior. Permita que o programa salve o resultado em "+
    "um arquivo de texto CSV. Permita que o programa abra o arquivo de texto CSV e exiba o conteúdo na tela.";

    public static final String questao36 = "36. Construa e use uma função para calcular o número fatorial de um número utilizando recursividade.";

    public static final String questao37 = "37. Calcule o somatório dos números inteiros do intervalo entre dois números. "+
    ...
    public static final String questao38 = "38. Utilizando o recurso Generic de Java, faça um método para exibir um objeto "+
