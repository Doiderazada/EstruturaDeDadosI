...
public class Questao15Controller {
    ...
    private void exibirConteudo() { 
        ...
        textEnunciado.setText(EnunciadoDasQuestoes.questao15.substring(3));
    }
    ...
    private void setStilo() {
        if (App.darkMode) {
            ...
            telaQuestao15.setStyle("-fx-background-color: #282828");
