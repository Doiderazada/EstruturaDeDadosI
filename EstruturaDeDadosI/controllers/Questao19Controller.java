...
import questoes.Questao19;
import source.App;

public class Questao19Controller {
    ...
    private boolean verificarInput() {
        ...
        if (tfNumero.getText().isEmpty()) {
            ...
            if (num < 1 || num > 9) {
                showPopup("O número não pode exceder 9 ou ser menor que 1");
                return false;
            }
        }
    ...
    private void exibirConteudo() { 
        ...
        textEnunciado.setText(EnunciadoDasQuestoes.questao19.substring(3));
    }
    ...
    private void setStilo() {
        if (App.darkMode) {
            ...
            telaQuestao19.setStyle("-fx-background-color: #282828");
