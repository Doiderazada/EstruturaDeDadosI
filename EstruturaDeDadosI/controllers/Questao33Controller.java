...
import questoes.Questao33;
import source.App;

public class Questao33Controller {
    ...
    private void exibirConteudo() { 
        ...
        textEnunciado.setText(EnunciadoDasQuestoes.questao33.substring(3));
    }
    ...
    private void setStilo() {
        if (App.darkMode) {
            ...
            telaQuestao33.setStyle("-fx-background-color: #282828");
